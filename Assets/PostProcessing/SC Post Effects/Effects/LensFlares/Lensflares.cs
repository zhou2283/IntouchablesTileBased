...
namespace SCPE
{
    ...
    public sealed class LensFlares : PostProcessEffectSettings
    {
        ...
        [Range(0.01f, 2f), DisplayName("Threshold")]
        public FloatParameter luminanceThreshold = new FloatParameter { value = 0.66f };
        ...
        [Range(0f, 20f), DisplayName("Chromatic Abberation")]
        ...
        [Range(1, 2), DisplayName("Distance")]
        public FloatParameter distance = new FloatParameter { value = 1.5f };

        [Range(1, 10), DisplayName("Falloff")]
        ...
        [Header("Blur")]
        [Range(1, 8), DisplayName("Blur")]
        public FloatParameter blur = new FloatParameter { value = 2f };

        [Range(1, 12), DisplayName("Iterations"), Tooltip("A higher itteration count affects performance but looks smoother")]
    ...
    public sealed class LensFlaresRenderer : PostProcessEffectRenderer<LensFlares>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            sheet.properties.SetFloat("_Ghosts", settings.itterations);
