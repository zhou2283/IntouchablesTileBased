        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (mode.value.intValue)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    EditorGUILayout.HelpBox("Creates an edge where the luminance value of a pixel differs from its neighbors past the threshold", MessageType.Info);
                    break;
            }
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                fadeDistance.value.floatValue = EditorGUILayout.Slider(fadeDistance.value.floatValue, 0f, 10000f);
